...
{
  /* General */
  public $sitename = "Agrophos"; //Name of your site, can be changed later
  public $language = "en-US"; //Default language
  public $mainColor = "4e9525"; //Default color, can be changed later
  public $logoPath = ""; //Default logo path, can be changed later
  public $appUrl = "/Agrophos-cms"; //Base URL, trailing slash not needed

  /* Database */
  public $dbHost="localhost"; //Database host
  public $dbUser="root"; //Database username
  public $dbPassword=""; //Database password
  public $dbDatabase="agrophos"; //Database name
